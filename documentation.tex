...
Die folgende Liste an Tests soll eine ausreichende Verifizierung der Operationen auf den Sets ermöglichen:
...
\subsection{Set als Array}
\label{sec:setArray-V}

Verifizieren

\subsection{Set als Array von Containern}
\label{sec:setConArray-V}
...
\subsection{Set als Array}
\label{sec:setArray-A}

Verifizieren

\subsection{Set als Array von Containern}
\label{sec:setConArray-A}
